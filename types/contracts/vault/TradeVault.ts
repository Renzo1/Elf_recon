...
export interface TradeVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TradeVault extends BaseContract {
  connect(runner?: ContractRunner | null): TradeVault;
  waitForDeployment(): Promise<this>;

  interface: TradeVaultInterface;
  ...
  revokeAdmin: TypedContractMethod<[admin: AddressLike], [void], "nonpayable">;
