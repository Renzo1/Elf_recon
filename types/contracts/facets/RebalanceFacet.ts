...
export interface RebalanceFacetInterface extends Interface {
...
export interface RebalanceFacet extends BaseContract {
  connect(runner?: ContractRunner | null): RebalanceFacet;
  waitForDeployment(): Promise<this>;

  interface: RebalanceFacetInterface;
