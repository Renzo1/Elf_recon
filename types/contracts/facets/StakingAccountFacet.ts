...
export interface StakingAccountFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface StakingAccountFacet extends BaseContract {
  connect(runner?: ContractRunner | null): StakingAccountFacet;
  waitForDeployment(): Promise<this>;

  interface: StakingAccountFacetInterface;
