...
export declare namespace IConfig {
  ...
  export type LpPoolConfigParamsStruct = {
    stakeToken: AddressLike;
    config: AppPoolConfig.LpPoolConfigStruct;
  };

  export type LpPoolConfigParamsStructOutput = [
    stakeToken: string,
    config: AppPoolConfig.LpPoolConfigStructOutput
  ] & { stakeToken: string; config: AppPoolConfig.LpPoolConfigStructOutput };

  export type SymbolConfigParamsStruct = {
    symbol: BytesLike;
    config: AppConfig.SymbolConfigStruct;
  };

  export type SymbolConfigParamsStructOutput = [
    symbol: string,
    config: AppConfig.SymbolConfigStructOutput
  ] & { symbol: string; config: AppConfig.SymbolConfigStructOutput };

  export type UsdPoolConfigParamsStruct = {
    config: AppPoolConfig.UsdPoolConfigStruct;
  };

  export type UsdPoolConfigParamsStructOutput = [
    config: AppPoolConfig.UsdPoolConfigStructOutput
  ] & { config: AppPoolConfig.UsdPoolConfigStructOutput };

  export type VaultConfigParamsStruct = {
    lpVault: AddressLike;
    tradeVault: AddressLike;
    portfolioVault: AddressLike;
  };
  ...
  ] & { lpVault: string; tradeVault: string; portfolioVault: string };
}

export interface ConfigFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getConfig"
      | "getPoolConfig"
  ...
  encodeFunctionData(
    ...
    values: [IConfig.CommonConfigParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "setPoolConfig",
    values: [IConfig.LpPoolConfigParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "setSymbolConfig",
    values: [IConfig.SymbolConfigParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setUsdPoolConfig",
    values: [IConfig.UsdPoolConfigParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "setVaultConfig",
    values: [IConfig.VaultConfigParamsStruct]
  ): string;
...
export interface ConfigFacet extends BaseContract {
  connect(runner?: ContractRunner | null): ConfigFacet;
  waitForDeployment(): Promise<this>;

  interface: ConfigFacetInterface;
  ...
  setConfig: TypedContractMethod<
    [params: IConfig.CommonConfigParamsStruct],
    [void],
    "nonpayable"
  >;

  setPoolConfig: TypedContractMethod<
    [params: IConfig.LpPoolConfigParamsStruct],
    [void],
    "nonpayable"
  >;

  setSymbolConfig: TypedContractMethod<
    [params: IConfig.SymbolConfigParamsStruct],
    [void],
    "nonpayable"
  >;
  ...
  setUsdPoolConfig: TypedContractMethod<
    [params: IConfig.UsdPoolConfigParamsStruct],
    [void],
    "nonpayable"
  >;

  setVaultConfig: TypedContractMethod<
    [params: IConfig.VaultConfigParamsStruct],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setSymbolConfig"
  ): TypedContractMethod<
    [params: IConfig.SymbolConfigParamsStruct],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setUsdPoolConfig"
  ): TypedContractMethod<
    [params: IConfig.UsdPoolConfigParamsStruct],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setVaultConfig"
  ): TypedContractMethod<
    [params: IConfig.VaultConfigParamsStruct],
    [void],
    "nonpayable"
