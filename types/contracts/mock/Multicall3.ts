...
export interface Multicall3Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getCurrentBlockPrevrandao",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Multicall3 extends BaseContract {
  ...
  getCurrentBlockPrevrandao: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getCurrentBlockPrevrandao"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
